#!/usr/bin/env python3
"""Train a focused 4-class YOLOv8n PPE violation detector."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Train YOLOv8n on the 4-class PPE violation dataset")
    parser.add_argument("--data", required=True, type=Path)
    parser.add_argument(
        "--model",
        default="yolov8n.pt",
        help="Starting YOLOv8n weights. Pass a local .pt path if the checkpoint is already downloaded.",
    )
